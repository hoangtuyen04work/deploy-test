...
public interface PostService {
    ...
    // PAGE = 2 -> PROFILE PAGE;
    // PAGE = 3 -> SEARCH PAGE
    PageResponse<PostResponse> getPost(String userId, Integer page, Integer size, int PAGE, String keyWord) throws AppException;
    ...
    PostResponse newPost(PostCreationRequest request);
