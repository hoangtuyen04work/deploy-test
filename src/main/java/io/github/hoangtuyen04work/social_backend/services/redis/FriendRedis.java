...
public class FriendRedis {
    ...
    public Set<FriendSummaryResponse> getMyFriend(String myId) throws JsonProcessingException {
    ...
    public void saveGetMyFriend(Set<FriendSummaryResponse> data, String myId) throws JsonProcessingException {
    ...
    public PageResponse<UserSummaryResponse> getAllWaiting(String myId, Integer page, Integer size)
            throws JsonProcessingException {
        String json = (String) redisTemplate.opsForValue().get("WaitingOF :" + myId + "page:" + page + "size:" + size);
        if (json == null) return null;
        return mapper.readValue(json, new TypeReference<PageResponse<UserSummaryResponse>>(){});
    }
    ...
    public void saveGetAllWaiting(PageResponse<UserSummaryResponse> data, String myId, Integer page, Integer size)
            throws JsonProcessingException {
        String key = "WaitingOF :" + myId + "page:" + page + "size:" + size;
        String value = mapper.writeValueAsString(data);
        redisTemplate.opsForValue().set(key, value);
    }
}